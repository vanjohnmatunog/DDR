<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmailSearch_CopyTo.ascx.cs" Inherits="EmailSearch_CopyTo_EmailSearch_CopyTo" %>
...
<asp:UpdatePanel ID="uPnlMain" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true" >
    <ContentTemplate>
                        ...
                        <div class="table-responsive mh-50">                          
                            <asp:GridView ID="grdEmployee" CssClass="footable" runat="server" AutoGenerateColumns="false" EmptyDataText="There are no data records to display." AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Employee/Group Email"  >
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmpName" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="rowHeight alignCenter" />
                                    </asp:TemplateField>
                                   <%-- <asp:TemplateField HeaderText="Dept">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDept" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle CssClass="rowHeight alignCenter" />
                                    </asp:TemplateField>--%>
                                    <asp:TemplateField HeaderText="">
                                        <ItemTemplate>
                                            <asp:Button ID="btnSelect" runat="server" Text="Select" CommandArgument='<%# Eval("Email") %>' CommandName='<%# Eval("Email") %>'
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $('[id*=ContentPlaceHolder1_EmailSearch_grdEmployee]').footable();
            });    
        </script>      
    </ContentTemplate>
</asp:UpdatePanel>